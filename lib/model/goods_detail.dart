class GoodsOutModel {
  ...
  GoodsOutModel({this.code, this.message, this.data});

  GoodsOutModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    data = json['data'] != null ? new GoodsInfo.fromJson(json['data']) : null;
  }
...
class GoodsInfo {
  ...
  GoodsInfo({this.goodInfo, this.goodComments, this.advertesPicture});
